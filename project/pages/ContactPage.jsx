      ...
      <Section bg="surface">
        <div style={{ display: 'grid', gridTemplateColumns: '1.4fr 1fr', gap: 'var(--space-stack-lg)', alignItems: 'start' }}>
          ...
          <div>
            ...
            <p style={{ fontFamily: 'var(--font-body)', fontSize: '1rem', lineHeight: 1.5, margin: 0 }}>Primarily North Island, New Zealand — But we do have nationwide capability. We come to your location and work around your schedule to minimise disruption..
            ...
            <p style={{ fontFamily: 'var(--font-body)', fontSize: '1rem', lineHeight: 1.5, margin: 0 }}>Setup Fee Plus per m² rate
depending on access & condition.
100% lifetime guarantee included.</p>
          </div>
        </div>
      </Section>
    </main>);
