    ...
    <main>
      <Section bg="deep-purple" narrow style={{ textAlign:'center' }}>
        ...
        <p style={{ fontFamily:'var(--font-body)', fontSize:'1.25rem', color:'rgba(255,255,255,0.9)', lineHeight:1.6, margin:0 }}>
          One method — wet-saw diamond blade. Many surfaces. Pick the one you need.
        </p>
      </Section>
      ...
      <Section bg="concrete-white" narrow>
        ...
        <Button variant="primary" href="#/contact" onClick={() => onNavigate('#/contact')}><span style={{ color: 'rgb(59, 31, 110)' }}>Get a Quote</span></Button>
      </Section>
    </main>
  );
}
