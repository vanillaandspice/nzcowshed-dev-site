      ...
      <div style={{
        ...
        <nav style={{ display: isMobile ? 'none' : 'flex', alignItems: 'center', gap: 32 }}>
          {NAV_LINKS.map((link) => {
            if (link.dropdown) {
              return (
                <div key={link.href} style={{ position: 'relative', height: '100%', display: 'flex', alignItems: 'center' }}
                  ...
                  <button onClick={go(link.href)} style={{
                    ...
                    display: 'flex', alignItems: 'center', gap: 4, padding: 0, height: '100%',
        ...
        <a href="#/contact" onClick={go('#/contact')} style={{
          ...
          background: 'var(--safety-orange)', color: 'var(--concrete-white)',
          fontFamily: 'var(--font-heading)', fontSize: '1.125rem', letterSpacing: '0.05em',
